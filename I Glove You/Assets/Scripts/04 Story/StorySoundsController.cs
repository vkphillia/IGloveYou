...
public class StorySoundsController : MonoBehaviour
{
	...
	public static StorySoundsController _Instance = null;

	//property to get instance
	public static StorySoundsController Instance {
		get {
			//if we do not have Instance yet
			if (_Instance == null)
			{
				_Instance = (StorySoundsController)FindObjectOfType (typeof(StorySoundsController));
			}
			return _Instance;
		}
	}
	...
	void Update ()
	{
		if (StoryManager.Instance.currentState == StoryGameState.Playing && !bgMusic.isPlaying)
		{
			//Debug.Log ("playing");
			bgMusic.Play ();
		}
		else if (StoryManager.Instance.currentState != StoryGameState.Playing && bgMusic.isPlaying)
		{
